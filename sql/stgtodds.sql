...
TRUNCATE TABLE dds.stock_history;

INSERT INTO dds.stock_history (
      ticker_id     
    , date        
    , "open"      
    , high        
...
FROM stg.stock_history t1
    JOIN dds.stock_info t2 USING(ticker);

TRUNCATE TABLE dds.stock_dividends_history;

INSERT INTO dds.stock_dividends_history(
    ticker_id
    , date
    , dividends
)
...
INSERT INTO dds.stock_balance_sheet(
                             date,
                             ticker_id, 
